...
router.put("/posts/:postId", [body("title").isLength({ min: 5 }).withMessage("Input title tidak sesuai"), body("body").isLength({ min: 5 }).withMessage("input body tidak sesuai")], blogController.updateBlogPost);
